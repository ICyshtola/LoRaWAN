...
public class new_secret_mess extends AppCompatActivity {
    private Button con;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_secret_mess);
        ...
        con.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!str1.equals(str2)){
                    ...
                    new_secret_mess.this.runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            new AlertDialog.Builder(new_secret_mess.this)
                                    .setTitle("系统提示")
                                    .setMessage("是否确认修改？")
                                            ...
                                            new Thread(new Runnable() {
                                                ...
                                                public void run() {
                                                    ...
                                                    Request request = new Request.Builder()
                                                            .url(LoginActivity.IP+"/user/chgwithPcode")
                                                            .post(requestBody)
                                                            .build();
